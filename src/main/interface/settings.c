...
// PG_GYRO_CONFIG
    ...
    { "imuf_w",                     VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 1024  }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, imuf_w) },
...
#endif
    { "safe_idle_enabled", VAR_UINT8  | MODE_LOOKUP,  .config.lookup = { TABLE_OFF_ON }, PG_PID_CONFIG, offsetof(pidConfig_t, safe_idle_enabled) },    // off, on - enables the safe idle logic
...
// PG_PID_PROFILE
    ...
    { "spa_rate_p",                 VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250}, PG_PID_PROFILE, offsetof(pidProfile_t, setPointPTransition) },
    { "spa_rate_i",                 VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250}, PG_PID_PROFILE, offsetof(pidProfile_t, setPointITransition) },
    { "spa_rate_d",                 VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250}, PG_PID_PROFILE, offsetof(pidProfile_t, setPointDTransition) },
    ...
    { "feathered_pids",             VAR_UINT8  | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, feathered_pids) },
    ...
    { "boost_limit",                VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, errorBoostLimit) },
    { "emu_iterm",                  VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 1, 10 }, PG_PID_PROFILE, offsetof(pidProfile_t, emu_iterm) },
    { "emu_dterm",                  VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 1, 10 }, PG_PID_PROFILE, offsetof(pidProfile_t, emu_dterm) },
