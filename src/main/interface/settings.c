...
// rateDynamics
    ...
    { "axis_lock_percent",          VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 0, 100 }, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, axis_lock_percent) },
    { "axis_lock_hz",               VAR_UINT8 | PROFILE_VALUE, .config.minmax = { 1, 50 }, PG_CONTROL_RATE_PROFILES, offsetof(controlRateConfig_t, axis_lock_hz) },
